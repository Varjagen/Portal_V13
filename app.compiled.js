...
function SettingsModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Preferences are stored on this device only.")), mode === 'player' && /*#__PURE__*/React.createElement("div", {
    className: "settings-section"
  }, /*#__PURE__*/React.createElement("label", {
    className: "settings-label"
  }, "Sickness Effects"), /*#__PURE__*/React.createElement("div", {
    className: "toggle-row",
    ...
    htmlFor: "sickness-effects-toggle",
    style: { cursor: 'pointer', fontSize: 13 }
  }, "Screen wobble & vignette when your character is sluggish or sick")), /*#__PURE__*/React.createElement("div", {
    className: "settings-hint"
...
function DMInterface({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onPlay: async soundId => {
      ...
      if (dataUrl) sync.sendSoundData(soundId, name, dataUrl);
    },
    onStop: soundId => {
      dispatch({
        type: 'SOUND_EVENT',
...
function PlayerInterface({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: `app-shell ${sicknessWobbleClass}`
  }, effectsEnabled && sicknessLevel >= 3 && /*#__PURE__*/React.createElement("div", {
    className: "sickness-vignette"
  }), /*#__PURE__*/React.createElement("div", {
    className: "topbar"
  }, /*#__PURE__*/React.createElement("span", {
    className: "mode-badge player"
...
function Session({
  ...
  const sentSoundsRef = useRef(new Set());
  useEffect(() => {
